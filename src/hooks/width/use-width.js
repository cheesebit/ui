 ...
 * @param {React.MutableRefObject} props.ref - Option ref to element whose width whould be monitored.
 * @param {Function} props.onWidthChange - Callback function to run when element's or window's width changes.
 */
