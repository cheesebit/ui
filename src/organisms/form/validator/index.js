 ...
 * @return {ValidationRule} Validation rule broke down into properties.
 ...
 * @return {Object} Validation rule broke down into properties.
 */
 ...
 * @return {string} Validation rule broke down into properties.
 */
 ...
 *
 * @return {boolean|Array<string>} `true` if valid, and array with the name of the validators
